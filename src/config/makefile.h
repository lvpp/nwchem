...
ifneq ($(NWCHEM_TARGET),$(findstring $(NWCHEM_TARGET), LINUX64 LINUX MACX MACX64 CATAMOUNT CYGWIN64 MINGW64 CYGNUYS CYGWIN BGL BGP BGQ HPUX HPUX64 IBM IBM64 LAPI LAPI64 PURESOLARIS SOLARIS SOLARIS64))
    error20:
	$(info     )
...
ifneq ($(TARGET),LINUX)
    ifeq ($(TARGET),$(findstring $(TARGET),LINUX64 CYGWIN64 MINGW64 CATAMOUNT))
